...
leResult screenShow_Screen1(void)
{
    ...
    Screen1_PanelBackground->fn->setSize(Screen1_PanelBackground, 800, 480);
    ...
    Screen1_ImageWidget0->fn->setPosition(Screen1_ImageWidget0, 311, 170);
    ...
    Screen1_PositionWidget->fn->setPosition(Screen1_PositionWidget, 360, 288);
    ...
    Screen1_ButtonWidget_RunLeft->fn->setPosition(Screen1_ButtonWidget_RunLeft, -400, 320);
    Screen1_ButtonWidget_RunLeft->fn->setSize(Screen1_ButtonWidget_RunLeft, 800, 160);
    ...
    Screen1_ButtonWidget_RunRight->fn->setPosition(Screen1_ButtonWidget_RunRight, 400, 320);
    Screen1_ButtonWidget_RunRight->fn->setSize(Screen1_ButtonWidget_RunRight, 800, 160);
    ...
    Screen1_ButtonWidget_Jump->fn->setSize(Screen1_ButtonWidget_Jump, 800, 320);
    ...
    Screen1_ButtonWidget_ScreenChange->fn->setPosition(Screen1_ButtonWidget_ScreenChange, 670, 0);
